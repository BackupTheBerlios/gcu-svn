 ...
 *
 */
public class ViewGoodGearsAction extends LocalizedAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8355288480356063529L;
	
	private Main main;
	/**
	 * @param name
	 */
	public ViewGoodGearsAction(Main main) {
		super("Good");
		this.main = main;
	}
	...
	public void actionPerformed(ActionEvent e) {
		main.getStyle().setGearVisibility(ChainlineStatus.GOOD);
		main.update();
		main.getGearBoxOutput().dataChanged();
	}
